...
/* FORCE6_C */
extern void plaq_u1frc(void);
extern void force6(double c);
extern double action6(int icom);
...
/* GENFRC_C */
extern void sw_su3frc(double c);
extern void sw_u1frc(double c);
extern void hop_su3frc(double c);
extern void hop_u1frc(double c);
