...
* License (GPL)
*
* Integration of the Wilson flow for SU(3) gauge field.
*
...
void fwd_su3_euler(int n,double eps)
{
   ...
   if (NPROC>1)
   {
      ...
      error((iprms[0]!=n)||(dprms[0]!=eps),1,
            "fwd_su3_euler [wflow.c]","Parameters are not global");
   }
...
void fwd_su3_rk2(int n,double eps)
{
   ...
   if (NPROC>1)
   {
      ...
      error((iprms[0]!=n)||(dprms[0]!=eps),1,
            "fwd_su3_rk2 [wflow.c]","Parameters are not global");
   }
...
void fwd_su3_rk3(int n,double eps)
{
   ...
   if (NPROC>1)
   {
      ...
      error((iprms[0]!=n)||(dprms[0]!=eps),1,
            "fwd_su3_rk3 [wflow.c]","Parameters are not global");
   }
