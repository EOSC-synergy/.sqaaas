...
* They assume that the Dirac-operator parameters have been set through
* set_dirac_parms*() (see flags/lat_parms.c).
*
            ...
            spinor_dble *eta,spinor_dble *psi,int *status)
{
   ...
   error_root((query_flags(SW_UP2DATE)!=1)||
              (query_flags(SW_E_INVERTED)!=0)||
              (query_flags(SW_O_INVERTED)!=0),1,
              "tmcg [tmcg.c]",
