...
* to the array. The Dirac-operator parameters are the ones last set by
* set_dirac_parms*() [flags/lat_parms.c] and it is taken for granted that the
* parameters of the solver have been set by set_solver_parms()
      ...
      if (get_chrono(icr,chi))
      {
         ...
         if (res1<1.0)
         {
            ...
            if (res1>sp.res)
            {
               ...
               dfl_sap_gcr2(sp.idfl,sp.nkv,sp.nmx,sp.res/res1,mu,rho,eta,
                            status);
               ...
               else
               {
                  ...
                  dfl_sap_gcr2(sp.idfl,sp.nkv,sp.nmx,sp.res,-mu,eta,chi,status+3);
               }
            }
            else
            {
