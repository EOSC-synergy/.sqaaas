...
* structures see README.Aw. The Dirac-operator parameters are retrieved from the
...
void set_Aw(double mu)
{
   ...
   error_root(query_flags(AW_UP2DATE)!=1,1,
              "set_Aw [Aw_ops.c]",
...
int set_Awhat(double mu)
{
   ...
   error_root(query_flags(AWHAT_UP2DATE)!=1,1,
              "set_Awhat [Aw_ops.c]",
              "Flags debug: Something is not working");
