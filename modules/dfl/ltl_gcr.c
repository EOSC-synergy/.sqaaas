...
* linsolv/fgcr4vd.c). The improvement coefficients, the parameters of the Dirac
* operator and the parameters of the deflation subspace are assumed to be set by
* set_lat_parms(), set_bc_parms(), set_dirac_parms() and set_dfl_parms(). It is
