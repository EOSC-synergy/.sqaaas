...
*                         coefficients.
*
*  set_dirac_parms()      Dirac operator parameters.
*
                   ...
                   spinor_dble *eta,spinor_dble *psi,int *status)
{
   ...
   error_root((query_grid_flags(SAP_BLOCKS,HBGR_UP2DATE)!=1)||
              ...
              (query_grid_flags(SAP_BLOCKS,SW_UP2DATE)!=1)||
              (query_flags(SW_UP2DATE)!=1)||
              (query_flags(SW_E_INVERTED)==1)||
              (query_flags(SW_O_INVERTED)==1),1,
              "dfl_sap_gcr [dfl_sap_gcr.c]",
