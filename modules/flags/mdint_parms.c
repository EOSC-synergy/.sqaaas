                              ...
                              int nstep,int nfr,int *ifr)
{
   ...
   check_global_int("set_mdint_parms",4,ilv,(int)(integrator),nstep,nfr);
   check_global_dble("set_mdint_parms",1,lambda);
   check_global_intarray("set_mdint_parms",nfr,ifr);
