...
* License (GPL)
*
* Check of sw_su3frc(), hop_su3frc(), sw_u1frc() and hop_u1frc().
*
*******************************************************************************/
...
static double su3dSdt(int k,spinor_dble **phi)
{
   int l;
   spinor_dble **wsd;
   mdflds_t *mdfs;
...
static double u1dSdt(int k,spinor_dble **phi)
{
   int l;
   spinor_dble **wsd;
   mdflds_t *mdfs;
...
static double su3dSdt_det(ptset_t set)
{
   int ifail;
   mdflds_t *mdfs;
...
static double u1dSdt_det(ptset_t set)
{
   int ifail;
   mdflds_t *mdfs;
...
int main(int argc,char *argv[])
{
   ...
   if (my_rank==0)
   {
      ...
      printf("\n");
      printf("Check of sw_su3frc(), hop_su3frc(), sw_u1frc() and hop_u1frc()\n");
      printf("--------------------------------------------------------------\n\n");
