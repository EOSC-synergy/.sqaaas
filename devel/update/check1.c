...
static int my_rank;
static force_t force[]={FRG_SU3,FRF_TM1,FRF_TM1_EO,FRF_TM1_EO_SDET,
                        FRF_TM2,FRF_TM2_EO,FRF_RAT,FRF_RAT_SDET,FRG_U1};


static void read_flds_parms(void)
{
   int gg;
   char line[NAME_SIZE];
   ...
   if (my_rank==0)
   {
      ...
      if (strcmp(line,"SU(3)")==0)
         ...
         error_root(1,1,"read_flds_parms [main.c]",
...
int main(int argc,char *argv[])
{
   ...
   error(i!=(nop-1),1,"main [check1.c]",
         "Parameter nop returned by mdsteps is incorrect");
