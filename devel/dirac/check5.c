...
int main(int argc,char *argv[])
{
   ...
   if (my_rank==0)
   {
      ...
      if (bc!=0)
         error_root(sscanf(argv[bc+1],"%d",&bc)!=1,1,"main [check5.c]",
                    "Syntax: check5 [-bc <type>] [-cs <cstar>] [-gg <gauge>] [-q <echarge>]");
      ...
      if (cf!=0)
         error_root(sscanf(argv[cf+1],"%d",&cf)!=1,1,"main [check5.c]",
                  "Syntax: check5 [-bc <type>] [-cs <cstar>] [-gg <gauge>] [-q <echarge>]");
      else
         cf=1;
      ...
      if (q!=0)
      {
         error_root(sscanf(argv[q+1],"%d",&q)!=1,1,"main [check5.c]",
                  "Syntax: check5 [-bc <type>] [-cs <cstar>] [-gg <gauge>] [-q <echarge>]");
      }
      else
         q=-3;
   ...
   dp=set_dirac_parms9(q,-0.0123,su3csw,u1csw,cF[0],cF[1],0.0,0.0,0.0);
   print_dirac_parms();
