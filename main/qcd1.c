...
static void setup_files(void)
{
   ...
   sprintf(msdat_file,"%s/%s.ms3.dat",dat_dir,nbase);
...
{
   int nfl,ifl,bc,sf,cs;
   double phi[2],phi_prime[2];
   double beta,c0,cG,cG_prime;
   double kappa,csw,cF,cF_prime,th1,th2,th3;
   ...
   for (ifl=0;ifl<nfl;ifl++)
   {
      ...
      set_qlat_parms(ifl,kappa,0,csw,0.0,cF,cF_prime,th1,th2,th3);
   }
...
static void read_dfl_parms(void)
{
   ...
   double kappa,mu,csw,cF,cF_prime,th1,th2,th3,res,dtau;
   ...
   set_dfl_gen_parms(kappa,mu,0,csw,0.0,cF,cF_prime,th1,th2,th3,ninv,nmr,ncy);
