...
static void read_flds_bc_lat_parms(void)
{
   ...
   set_dirac_parms9(qhat,m0,su3csw,u1csw,cF,cF_prime,th1,th2,th3);
   ...
   if (my_rank==0)
   {
      ...
      error_root((x0<0)||(x0>=N0),1,"read_flds_bc_lat_parms [ms4.c]",
      ...
      error_root(nsrc<1,1,"read_flds_bc_lat_parms [ms4.c]",
...
int main(int argc,char *argv[])
{
   ...
   for (nc=first;(iend==0)&&(nc<=last);nc+=step)
   {
      ...
      else
      {
         ...
         error(cnfg_type!=gauge(),1,"main [ms4.c]",
